...
def universal_transformer_gpt_model(
    ...
    plot_model(model, to_file='universal_transformer_gpt_model.png')
    return model
...
def vanilla_transformer_gpt_model(
    ...
    confidence_penalty = K.mean(
        ...
        K.sum(word_predictions * K.log(word_predictions), axis=-1))
    model.add_loss(confidence_penalty)
    plot_model(model, to_file='vanilla_transformer_gpt_model.png')
    return model
...
def transformer_bert_model(
    ...
    plot_model(model, to_file='transformer_bert_model.png')
    return model
